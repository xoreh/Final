...
class StudentAdapter4E : RecyclerView.Adapter<StudentAdapter4E.StudentViewHolder>() {
    private var stdList8: ArrayList<StudentModel> = ArrayList()
