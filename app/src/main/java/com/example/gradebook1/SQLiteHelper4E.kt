...
class SQLiteHelper4E (context: Context) : SQLiteOpenHelper(context, DATABASE_NAME,null, DATABASE_VERSION) {

    //THIS IS TO CREATE AND USE SQL DATABASE FOR A SPECIFIC GRADE OF STUDENT
    companion object{
        private const val DATABASE_VERSION = 1
        private const val DATABASE_NAME = "student.db8"
        private const val TBL_STUDENT = "tbl_student8"
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTb8Student = ("CREATE TABLE " + TBL_STUDENT + "("
    ...
    fun getAllStudent(): ArrayList<StudentModel>{
        val stdList8: ArrayList<StudentModel> = ArrayList()
