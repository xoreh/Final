...
class SeniorEmpty : AppCompatActivity() {
    ...
    private lateinit var  sqLiteHelper: SQLiteHelper4E
    private lateinit var recyclerView: RecyclerView

    //THESE VARIABLES ARE PRIVATE AND MAKE SURE THEY ARE NULL
    private var adapter: StudentAdapter4E? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sqLiteHelper = SQLiteHelper4E(this)
    ...
    private fun getStudent(){
        val stdList8 = sqLiteHelper.getAllStudent()
        Log.e("pppp","${stdList8.size}")

        //SEND THE "ITEM/STUDENT" TO RecyclerView
        adapter?.addItems(stdList8)
    }
