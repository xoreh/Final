...
class JuniorActivity : AppCompatActivity() {
    ...
    private lateinit var  sqLiteHelper: SQLiteHelperJU
    private lateinit var recyclerView: RecyclerView

    //THESE VARIABLES ARE PRIVATE AND MAKE SURE THEY ARE NULL
    private var adapter: StudentAdapter3? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sqLiteHelper = SQLiteHelperJU(this)
    ...
    private fun getStudent(){
        val stdList3 = sqLiteHelper.getAllStudent()
        Log.e("pppp","${stdList3.size}")

        //SEND THE "ITEM/STUDENT" TO RecyclerView
        adapter?.addItems(stdList3)
    }
