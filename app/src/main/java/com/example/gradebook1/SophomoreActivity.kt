...
class SophomoreActivity : AppCompatActivity() {
    ...
    private lateinit var  sqLiteHelper: SQLiteHelperSO
    private lateinit var recyclerView: RecyclerView

    //THESE VARIABLES ARE PRIVATE AND MAKE SURE THEY ARE NULL
    private var adapter: StudentAdapter2? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sqLiteHelper = SQLiteHelperSO(this)
    ...
    private fun getStudent(){
        val stdList2 = sqLiteHelper.getAllStudent()
        Log.e("pppp","${stdList2.size}")

        //SEND THE "ITEM/STUDENT" TO RecyclerView
        adapter?.addItems(stdList2)
    }
