...
class SeniorActivity : AppCompatActivity() {
    ...
    private lateinit var  sqLiteHelper: SQLiteHelperSE
    private lateinit var recyclerView: RecyclerView

    //THESE VARIABLES ARE PRIVATE AND MAKE SURE THEY ARE NULL
    private var adapter: StudentAdapter4? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sqLiteHelper = SQLiteHelperSE(this)
    ...
    private fun getStudent(){
        val stdList4 = sqLiteHelper.getAllStudent()
        Log.e("pppp","${stdList4.size}")

        //SEND THE "ITEM/STUDENT" TO RecyclerView
        adapter?.addItems(stdList4)
    }
