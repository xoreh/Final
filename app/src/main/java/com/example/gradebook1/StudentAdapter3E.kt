...
class StudentAdapter3E : RecyclerView.Adapter<StudentAdapter3E.StudentViewHolder>() {
    private var stdList7: ArrayList<StudentModel> = ArrayList()
