...
class StudentAdapter2E : RecyclerView.Adapter<StudentAdapter2E.StudentViewHolder>() {
    private var stdList6: ArrayList<StudentModel> = ArrayList()
